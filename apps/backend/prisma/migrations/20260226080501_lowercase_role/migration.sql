...
ALTER TABLE "public"."ConversationParticipant" ALTER COLUMN "role" DROP DEFAULT;
ALTER TABLE "ConversationParticipant" ALTER COLUMN "role" TYPE "Role_new" USING ("role"::text::"Role_new");
